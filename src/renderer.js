...
// Carregando a imagem do Piloto Mentor
...
// NOVA FUNÇÃO: Tela de Game Over com o Mentor
export function drawGameOverScreen(ctx, score, message) {
    ...
    // Desenha o Piloto Mentor
    if (spriteDriver.complete) {
        // Desenha o piloto centralizado (ajuste o tamanho conforme necessário)
    ...
    ctx.fillText("Pressione 'R' para tentar de novo", w / 2, h / 2 + 220);
